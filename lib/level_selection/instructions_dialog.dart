                  ...
                  Row(
                    ...
                    children: [
                      ...
                      const Flexible(
                        flex: 7,
                        child: Text(
                          'Tap/click on the screen to raise the submarine up.',
                        ),
                      ),
                    ],
                  ),
                  Row(
                    ...
                    children: [
                      const Flexible(
                        flex: 7,
                        child: Text(
                          'You have to collect as many plastic items to save the ocean!.',
                        ),
                      ),
                      const SizedBox(width: 20),
                      Flexible(
                    ...
                    children: [
                      Flexible(
                        ...
                        child: SizedBox(
                          width: 200,
                          height: 100,
                          child: SpriteWidget.asset(path: 'enemies/Shark4.png'),
                        ),
                      ),
                      const SizedBox(width: 20),
                      const Flexible(
                        flex: 6,
                        child: Text(
                          'Watch out for these, they will make you drop all the plastics collected.',
                        ),
                      )
                    ],
                  ),
